...
export default function MainPage() {
  ...
  // TODO(BE): 인기 산/이달의 산 데이터 — GET /mtn/list (필요시 추천순 정렬).
  //   useEffect 로 호출 후 setState → 아래 MOUNTAINS/FEATURED 더미를 응답으로 교체.
  //   커뮤니티 미리보기는 GET /board?category=FREE (최신 5건).
  const onSearch = (e) => {
    e.preventDefault();
    // TODO(BE): 검색 — 결과 페이지에서 GET /track/search?name= 또는 GET /board?keyword= 호출
